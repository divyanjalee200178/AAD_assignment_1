...
<section class="container my-2 bg-dark w-50 text-light p-3">
    ...
    <form class="row g-3 p-3" action="category-update" method="post">
        <div class="col-md-6">
            <label for="code" class="form-label">Code</label>
            <input type="text" class="form-control" id="code" name="category_code">
        </div>
        <div class="col-md-6">
        ...
        <div class="col-md-12">
            ...
            <input type="file" id="image" name="category_image" required>
        </div>
