...
<html>
<head>
    <title>Product view customer side</title>
...
<div class="container">
    <div class="row">
        ...
        <div class="col-md-3">
            <div class="card">
                <img src="<%= request.getContextPath() + "/" + item.getImagePath() %>" class="card-img-top" alt="<%= item.getName() %>">
                <div class="card-body">
                    <h5 class="card-title"><%= item.getName() %></h5>
                    <h5 class="card-text"><%= item.getUnitPrice() %></h5>
                </div>
            </div>
        </div>
        <%
